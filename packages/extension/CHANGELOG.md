...
- **First extension keeps connection**: When multiple RunBrowser extensions are installed, the actively-used one (with tabs) now keeps the connection. New extensions are rejected with code 4002 instead of taking over.
