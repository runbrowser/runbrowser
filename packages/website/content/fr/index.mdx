...
Une extension Chrome et un CLI qui permettent à vos agents de contrôler **votre vrai navigateur** — avec les sessions, extensions et cookies déjà en place. Pas d'instance headless, pas de détection de bot, pas de mémoire supplémentaire. [Star sur GitHub](https://github.com/runbrowser/runbrowser).
