...
A Chrome extension and CLI that let your agents control **your actual browser** — with logins, extensions, and cookies already there. No headless instance, no bot detection, no extra memory. [Star on GitHub](https://github.com/runbrowser/runbrowser).
