...
| | Playwright / Puppeteer | Cookie-extraction tools | RunBrowser |
| --- | --- | --- | --- |
| Browser | Fresh, headless | None — replays cookies | **Yours, already running** |
| Login state | None | Copied out, goes stale | **Already there, stays fresh** |
| Credential stored | — | On disk, yours to secure | **None. Nothing is extracted** |
| Anti-bot | Detected on sight | Fails any check beyond cookies | **It is a real browser** |
| Request signing, token refresh | Reimplement it | Breaks | **The page does it** |
| Needs a live browser | No | No | **Yes** |
